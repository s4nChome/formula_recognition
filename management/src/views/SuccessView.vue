<template>
  <div>
    ...
    <el-table :data="tableData" stripe>
      ...
      <el-table-column prop="result" label="识别结果" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getCSV() {
      ...
      window.open('http://localhost:5000/success/export?fileType=csv&selectedModel=' + this.params.selectedModel)
    },

    // 导出TXT
    getTXT() {
      this.FileTypeDialogVisible = false
      window.open('http://localhost:5000/success/export?fileType=txt&selectedModel=' + this.params.selectedModel)
    },
  }
}
</script>